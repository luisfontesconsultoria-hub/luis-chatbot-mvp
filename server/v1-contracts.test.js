...
const assistant=require('../backend/commercial-assistant');
assert.equal(assistant.priority(95),'HIGH');
console.log('PASS Meta webhook + commercial assistant contract');
