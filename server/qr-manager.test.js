...
assert.strictEqual(shouldProcessUpsert('append','req-1'),false);
...
(async()=>{
assert.strictEqual(await resolveMessagePhone({remoteJid:'5511888888888@s.whatsapp.net'},null),'5511888888888');
