...
function assertRepository(repo) {
  const required = ['createLead','updateLead','getLead','listLeads','findOrCreateLeadByPhone','findOrCreateLeadByWhatsappIdentity','ingestInboundMessage','createMessage','listMessages','createEvent','listEvents','createAudit','createCapturedCompany','findDuplicateCompany','getCapturedCompany','updateCapturedCompany'];
