...
function assertRepository(repo) {
  const required = ['createLead','updateLead','getLead','listLeads','findOrCreateLeadByPhone','findOrCreateLeadByWhatsappIdentity','createMessage','listMessages','createEvent','listEvents','createAudit','createCapturedCompany','findDuplicateCompany','getCapturedCompany','updateCapturedCompany'];
